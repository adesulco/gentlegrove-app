export const EMOTIONS = [
  { name: "Happy", emoji: "😊", color: "#7EC8E3" },
  { name: "Sad", emoji: "😢", color: "#A8C6FA" },
  { name: "Angry", emoji: "😠", color: "#F4A9A8" },
  { name: "Scared", emoji: "😨", color: "#C3B1E1" },
  { name: "Surprised", emoji: "😲", color: "#B8E6C8" },
  { name: "Calm", emoji: "😌", color: "#B5D8CC" },
];
...
export const SCENARIOS_EXPLORERS = [
  { text: "Maya worked very hard on a drawing for her mom. When her mom saw it, she smiled really big and put it on the fridge. How does Maya feel?", answer: "Happy", visual: "🎨📌", teach: "When our effort is noticed and appreciated, we feel proud and happy." },
  { text: "Sam's friends are playing a game together, but nobody asked Sam to join. Sam is standing alone watching them. How does Sam feel?", answer: "Sad", visual: "🧑‍🦯👥", teach: "Being left out can make us feel sad and lonely. If you see someone alone, you can invite them to join." },
  { text: "Lily is trying to tell a story, but every time she starts talking, someone else talks over her. How does Lily feel?", answer: "Angry", visual: "🗣️🚫", teach: "Being interrupted can be very frustrating. Everyone deserves a chance to finish speaking." },
  { text: "Jake has to give a presentation in front of the whole class tomorrow. He keeps thinking about what might go wrong. How does Jake feel?", answer: "Scared", visual: "📊😰", teach: "Worrying about something new is normal. Practicing beforehand can help us feel more prepared." },
  { text: "Emma opens her lunchbox and finds her mom packed a special treat she was not expecting! How does Emma feel?", answer: "Surprised", visual: "🥒✨", teach: "A nice surprise happens when something good we did not plan for shows up!" },
...
export const SCENARIOS_NAVIGATORS = [
  { text: "Kai tripped in the hallway and his classmate said 'Nice one!' with a laugh. Kai is not sure if the classmate is being friendly or making fun of him. How might Kai feel?", answer: "Angry", visual: "🤦💬", teach: "Sometimes we are not sure if someone is joking or being mean. It is okay to ask them what they meant." },
  { text: "Mia spent three weeks painting something for an art competition. Another student won the prize. How might Mia feel?", answer: "Sad", visual: "🎨🏆", teach: "Losing after trying hard hurts. Feeling proud of your effort is important, even when you do not win." },
